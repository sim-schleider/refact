<?php
function assignCourseToStudent($conn, $student_id, $course_id, $passed) 
{
...
function getAllCoursesStudents($conn) 
{
...
function getCoursesByStudent($conn, $student_id) 
{
...
function updateStudentCourse($conn, $id, $student_id, $course_id, $passed) 
{
...
function removeStudentCourse($conn, $id) 
{
